...
temp_Gps_nc <- griddap(x = sst_dataset$dataset_id[2],
                    ...
                    fields = "sst",
                    fmt = "nc",
                    store = disk(path = "../../../ohw22-proj-biodiversity-indicators/Data/"))

temp_Gps_nc



sst_raster <- raster::raster("../../../ohw22-proj-biodiversity-indicators/Data/e11136594a145f6c452c0e63764b231c.nc")

prom_sst_gps <- raster::mean(sst_raster, 3)
raster::plot(sst_raster)
```
```{r}
raster::plot(prom_sst_gps)
```
